...
import { UnityBlogCardBG } from './UnityPlayerStyles2';
import './unityPlayer2.css';

const unityContext = new UnityContext({
    loaderUrl: "Build/Astar.loader.js",
    dataUrl: "Build/Astar.data",
    frameworkUrl: "Build/Astar.framework.js",
    codeUrl: "Build/Astar.wasm",
});

export function UnityPlayer2() {
        ...
        <GridContainer id="unity_app" style={ { marginTop: "60px", height: "100vh", alignContent: "start" } } >
            <UnityBlogCardBG>
                <BlogCardFG styles={ { alignItems: "center" } }>
                    ...
                    <TitleContent>
                        <HeaderThree title>{ "Search Algorithms" }</HeaderThree>
                        <Hr />
